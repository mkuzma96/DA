...
# np.savez('GPS_mod', b_coef=b_coef, sig_hat=sig_hat, a_coef=a_coef, data_test_bae=data_test_bae)

#%% Clever initialization + local optimization
...
# np.savez('CI', ci=ci, Y_opt=Y_obs_pred, Y_obs=Y_obs_pred)
